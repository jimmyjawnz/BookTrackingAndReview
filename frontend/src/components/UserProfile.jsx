        ...
        <div className="absolute top-0 left-0 w-full px-6 py-4 flex justify-between items-center">
          ...
          <div className="space-x-2">
            <button
              ...
              className="bg-purple-500 hover:bg-purple-600 px-4 py-1 rounded-lg">
              Edit Profile
            </button>

            <button
              onClick={() => setShowBookListModal(true)}
            ...
            <div className="bg-white text-black p-6 rounded-xl shadow-md w-full max-w-md">
              ...
              <div className="flex justify-end gap-4">
                <button
                  ...
                  className="bg-[#1E2939] text-white px-4 py-2 rounded">
                  Cancel
                </button>
                <button
                  onClick={handleSave}
                  className="bg-[#C575F4] text-white px-4 py-2 rounded">
                  Save
                </button>
              </div>
            </div>
